...
//   Input file: ../client/protocol/avdl/khulnasoft1/common.avdl
...
type KhulnasoftTime struct {
	Unix  Time  `codec:"unix" json:"unix"`
	Chain Seqno `codec:"chain" json:"chain"`
}

func (o KhulnasoftTime) DeepCopy() KhulnasoftTime {
	return KhulnasoftTime{
...
type RevokedKey struct {
	...
	Time KhulnasoftTime `codec:"time" json:"time"`
...
// that the user posts a Khulnasoft proof on the asserted service as the asserted
// user.
//
