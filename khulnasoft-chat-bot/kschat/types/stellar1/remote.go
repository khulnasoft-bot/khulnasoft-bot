...
type PaymentDirectPost struct {
	FromDeviceID       khulnasoft1.DeviceID     `codec:"fromDeviceID" json:"fromDeviceID"`
	To                 *khulnasoft1.UserVersion `codec:"to,omitempty" json:"to,omitempty"`
...
func (o PaymentDirectPost) DeepCopy() PaymentDirectPost {
	return PaymentDirectPost{
		...
		To: (func(x *khulnasoft1.UserVersion) *khulnasoft1.UserVersion {
			if x == nil {
				return nil
			}
			tmp := (*x).DeepCopy()
...
type PaymentRelayPost struct {
	...
	TeamID             khulnasoft1.TeamID       `codec:"teamID" json:"teamID"`
	DisplayAmount      string                `codec:"displayAmount" json:"displayAmount"`
	DisplayCurrency    string                `codec:"displayCurrency" json:"displayCurrency"`
...
type RelayClaimPost struct {
	KhulnasoftID         KhulnasoftTransactionID `codec:"khulnasoftID" json:"khulnasoftID"`
...
func (o RelayClaimPost) DeepCopy() RelayClaimPost {
	return RelayClaimPost{
		KhulnasoftID:         o.KhulnasoftID.DeepCopy(),
		Dir:               o.Dir.DeepCopy(),
		SignedTransaction: o.SignedTransaction,
...
type PaymentSummaryDirect struct {
	KbTxID              KhulnasoftTransactionID  `codec:"kbTxID" json:"kbTxID"`
	TxID                TransactionID         `codec:"txID" json:"txID"`
	...
	From                khulnasoft1.UserVersion  `codec:"from" json:"from"`
	FromDeviceID        khulnasoft1.DeviceID     `codec:"fromDeviceID" json:"fromDeviceID"`
...
type ClaimSummary struct {
	...
	Dir       RelayDirection       `codec:"dir" json:"dir"`
	ToStellar AccountID            `codec:"toStellar" json:"toStellar"`
	To        khulnasoft1.UserVersion `codec:"to" json:"to"`
}
...
type RequestPost struct {
	ToUser      *khulnasoft1.UserVersion `codec:"toUser,omitempty" json:"toUser,omitempty"`
	ToAssertion string                `codec:"toAssertion" json:"toAssertion"`
	Amount      string                `codec:"amount" json:"amount"`
...
func (o RequestPost) DeepCopy() RequestPost {
	return RequestPost{
		ToUser: (func(x *khulnasoft1.UserVersion) *khulnasoft1.UserVersion {
			if x == nil {
				return nil
			}
			tmp := (*x).DeepCopy()
...
type RequestDetails struct {
	Id                  KhulnasoftRequestID      `codec:"id" json:"id"`
	FromUser            khulnasoft1.UserVersion  `codec:"fromUser" json:"fromUser"`
	ToUser              *khulnasoft1.UserVersion `codec:"toUser,omitempty" json:"toUser,omitempty"`
	ToAssertion         string                `codec:"toAssertion" json:"toAssertion"`
	Amount              string                `codec:"amount" json:"amount"`
	Asset               *Asset                `codec:"asset,omitempty" json:"asset,omitempty"`
	...
	ToDisplayAmount     string                `codec:"toDisplayAmount" json:"toDisplayAmount"`
	ToDisplayCurrency   string                `codec:"toDisplayCurrency" json:"toDisplayCurrency"`
	FundingKbTxID       KhulnasoftTransactionID  `codec:"fundingKbTxID" json:"fundingKbTxID"`
...
type TimeboundsRecommendation struct {
	TimeNow khulnasoft1.UnixTime `codec:"timeNow" json:"time_now"`
