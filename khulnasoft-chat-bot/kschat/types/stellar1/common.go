...
type KhulnasoftTransactionID string

func (o KhulnasoftTransactionID) DeepCopy() KhulnasoftTransactionID {
	return o
}
...
type KhulnasoftRequestID string

func (o KhulnasoftRequestID) DeepCopy() KhulnasoftRequestID {
	return o
}
...
type EncryptedNote struct {
	...
	N         khulnasoft1.BoxNonce `codec:"n" json:"n"`
...
type NoteRecipient struct {
	User   khulnasoft1.UserVersion          `codec:"user" json:"user"`
	PukGen khulnasoft1.PerUserKeyGeneration `codec:"pukGen" json:"pukGen"`
}
...
type EncryptedRelaySecret struct {
	...
	E   []byte                        `codec:"e" json:"e"`
	N   khulnasoft1.BoxNonce             `codec:"n" json:"n"`
	Gen khulnasoft1.PerTeamKeyGeneration `codec:"gen" json:"gen"`
}
