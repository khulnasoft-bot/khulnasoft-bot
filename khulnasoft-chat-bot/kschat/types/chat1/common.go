...
type KBFSPath struct {
	...
	PathInfo     khulnasoft1.KBFSPathInfo `codec:"pathInfo" json:"pathInfo"`
}
...
type ConversationNotificationInfo struct {
	...
	Settings    map[khulnasoft1.DeviceType]map[NotificationKind]bool `codec:"settings" json:"settings"`
}
...
func (o ConversationNotificationInfo) DeepCopy() ConversationNotificationInfo {
	return ConversationNotificationInfo{
		...
		Settings: (func(x map[khulnasoft1.DeviceType]map[NotificationKind]bool) map[khulnasoft1.DeviceType]map[NotificationKind]bool {
			if x == nil {
				return nil
			}
			ret := make(map[khulnasoft1.DeviceType]map[NotificationKind]bool, len(x))
			for k, v := range x {
				kCopy := k.DeepCopy()
...
type ConversationReaderInfo struct {
	...
	UntrustedTeamRole khulnasoft1.TeamRole            `codec:"untrustedTeamRole" json:"untrustedTeamRole"`
...
type MsgEphemeralMetadata struct {
	...
	Generation khulnasoft1.EkGeneration `codec:"g" json:"g"`
...
type MessageClientHeader struct {
	...
	PairwiseMacs      map[khulnasoft1.KID][]byte  `codec:"pm" json:"pm"`
...
func (o MessageClientHeader) DeepCopy() MessageClientHeader {
	return MessageClientHeader{
		...
		PairwiseMacs: (func(x map[khulnasoft1.KID][]byte) map[khulnasoft1.KID][]byte {
			if x == nil {
				return nil
			}
			ret := make(map[khulnasoft1.KID][]byte, len(x))
			for k, v := range x {
				kCopy := k.DeepCopy()
...
type TeamMember struct {
	Uid    gregor1.UID               `codec:"uid" json:"uid"`
	Role   khulnasoft1.TeamRole         `codec:"role" json:"role"`
	Status khulnasoft1.TeamMemberStatus `codec:"status" json:"status"`
}
...
type ChatMemberDetails struct {
	Uid      khulnasoft1.UID      `codec:"uid" json:"uid"`
	Username string            `codec:"username" json:"username"`
	FullName khulnasoft1.FullName `codec:"fullName" json:"fullName"`
}
