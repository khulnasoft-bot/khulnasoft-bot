...
// A Khulnasoft chat channel. This can be a channel in a team, or just an informal channel between two users.
...
type MsgSender struct {
	...
	DeviceID   khulnasoft1.DeviceID `codec:"deviceID" json:"device_id"`
...
type MsgBotInfo struct {
	BotUID      khulnasoft1.UID `codec:"botUID" json:"bot_uid"`
...
type Thread struct {
	...
	Offline          bool                          `codec:"offline,omitempty" json:"offline,omitempty"`
	IdentifyFailures []khulnasoft1.TLFIdentifyFailure `codec:"identifyFailures,omitempty" json:"identify_failures,omitempty"`
...
type DeviceInfo struct {
	DeviceID          khulnasoft1.DeviceID     `codec:"deviceID" json:"id"`
	DeviceDescription string                `codec:"deviceDescription" json:"description"`
	DeviceType        khulnasoft1.DeviceTypeV2 `codec:"deviceType" json:"type"`
