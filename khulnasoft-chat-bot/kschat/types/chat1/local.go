...
import (
	...
	gregor1 "github.com/khulnasoft-bot/khulnasoft-bot/khulnasoft-chat-bot/kschat/types/gregor1"
	khulnasoft1 "github.com/khulnasoft-bot/khulnasoft-bot/khulnasoft-chat-bot/kschat/types/khulnasoft1"
	stellar1 "github.com/khulnasoft-bot/khulnasoft-bot/khulnasoft-chat-bot/kschat/types/stellar1"
)
...
type MessageSystemAddedToTeam struct {
	...
	Role     khulnasoft1.TeamRole `codec:"role" json:"role"`
...
type MessageSystemInviteAddedToTeam struct {
	...
	Adder      string                      `codec:"adder" json:"adder"`
	InviteType khulnasoft1.TeamInviteCategory `codec:"inviteType" json:"inviteType"`
	Role       khulnasoft1.TeamRole           `codec:"role" json:"role"`
}
...
type MessageSystemGitPush struct {
	...
	RepoID           khulnasoft1.RepoID           `codec:"repoID" json:"repoID"`
	Refs             []khulnasoft1.GitRefMetadata `codec:"refs" json:"refs"`
	PushType         khulnasoft1.GitPushType      `codec:"pushType" json:"pushType"`
...
func (o MessageSystemGitPush) DeepCopy() MessageSystemGitPush {
	return MessageSystemGitPush{
		...
		Refs: (func(x []khulnasoft1.GitRefMetadata) []khulnasoft1.GitRefMetadata {
			if x == nil {
				return nil
			}
			ret := make([]khulnasoft1.GitRefMetadata, len(x))
			for i, v := range x {
				vCopy := v.DeepCopy()
				ret[i] = vCopy
			}
...
type MessageRequestPayment struct {
	RequestID stellar1.KhulnasoftRequestID `codec:"requestID" json:"requestID"`
...
type OutboxRecord struct {
	...
	IdentifyBehavior khulnasoft1.TLFIdentifyBehavior `codec:"identifyBehavior" json:"identifyBehavior"`
...
type MessageUnboxedValid struct {
	...
	SenderDeviceType      khulnasoft1.DeviceTypeV2       `codec:"senderDeviceType" json:"senderDeviceType"`
	BodyHash              Hash                        `codec:"bodyHash" json:"bodyHash"`
...
type ConversationInfoLocal struct {
	...
	Visibility     khulnasoft1.TLFVisibility         `codec:"visibility" json:"visibility"`
...
type ConversationLocal struct {
	...
	IdentifyFailures []khulnasoft1.TLFIdentifyFailure `codec:"identifyFailures" json:"identifyFailures"`
...
func (o ConversationLocal) DeepCopy() ConversationLocal {
	return ConversationLocal{
		...
		IsEmpty: o.IsEmpty,
		IdentifyFailures: (func(x []khulnasoft1.TLFIdentifyFailure) []khulnasoft1.TLFIdentifyFailure {
			if x == nil {
				return nil
			}
			ret := make([]khulnasoft1.TLFIdentifyFailure, len(x))
			for i, v := range x {
				vCopy := v.DeepCopy()
				ret[i] = vCopy
			}
...
type GetInboxLocalQuery struct {
	...
	TlfVisibility     *khulnasoft1.TLFVisibility    `codec:"tlfVisibility,omitempty" json:"tlfVisibility,omitempty"`
	Before            *gregor1.Time              `codec:"before,omitempty" json:"before,omitempty"`
	After             *gregor1.Time              `codec:"after,omitempty" json:"after,omitempty"`
...
func (o GetInboxLocalQuery) DeepCopy() GetInboxLocalQuery {
	return GetInboxLocalQuery{
		...
		TlfVisibility: (func(x *khulnasoft1.TLFVisibility) *khulnasoft1.TLFVisibility {
			if x == nil {
				return nil
			}
			tmp := (*x).DeepCopy()
...
type NewConversationLocalArgument struct {
	...
	TlfVisibility khulnasoft1.TLFVisibility  `codec:"tlfVisibility" json:"tlfVisibility"`
	TopicName     *string                 `codec:"topicName,omitempty" json:"topicName,omitempty"`
	MembersType   ConversationMembersType `codec:"membersType" json:"membersType"`
}
...
type GetMutualTeamsLocalRes struct {
	TeamIDs    []khulnasoft1.TeamID `codec:"teamIDs" json:"teamIDs"`
	Offline    bool              `codec:"offline" json:"offline"`
	RateLimits []RateLimit       `codec:"rateLimits" json:"rateLimits"`
}
...
func (o GetMutualTeamsLocalRes) DeepCopy() GetMutualTeamsLocalRes {
	return GetMutualTeamsLocalRes{
		TeamIDs: (func(x []khulnasoft1.TeamID) []khulnasoft1.TeamID {
			if x == nil {
				return nil
			}
			ret := make([]khulnasoft1.TeamID, len(x))
			for i, v := range x {
				vCopy := v.DeepCopy()
				ret[i] = vCopy
			}
...
type AppNotificationSettingLocal struct {
	DeviceType khulnasoft1.DeviceType `codec:"deviceType" json:"deviceType"`
